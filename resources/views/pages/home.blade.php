                        ...
                        <a href="{{URL::to('/chi-tiet-san-pham/'.$product->product_id)}}">
                            <div class="single-products">
                                <div class="productinfo text-center">
                                    <img style="height:250px" src="/uploads/product/{{$product->product_image}}"
                                         alt=""/>
                                    <h2 style="font-size:18px">{{number_format($product->product_price).' '.'VND'}}</h2>
                                    ...
                                    <button class="btn btn-default show-modal-product-detail" data-toggle="modal"
                                            data-target="#{{$product->product_id}}-modal" style="background-color:#f45555; color:white">
