					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> (+84) 96 9377 903- (+84) 90 376 8379</a></li>
					...
					<div class="">
						<div class="logo pull-left">
							<a href="{{URL::to('/trang-chu')}}"><img style="width:50%; margin:-10px"
									src="{{asset('/frontend/images/logo_1997storee.png')}}" alt="" /></a>
						</div>
					</div>
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div style="height:410px" class="carousel-inner">
							...
							<div style="padding-left:1px" class="item @if($key==0) active @endif">
								...
								<img style="width:100%; height: 410px" src="/uploads/product/{{$tt->slide_image}}" alt="" />
											...
											<div class="single-products">
												<div class="productinfo text-center">
													<img style="height:220px;width:100%;"
														src="/uploads/product/{{$sell->product_image}}" alt="" />
													<h2 style="color:red">{{number_format($sell->product_price).' '.'VND'}}</h2>
