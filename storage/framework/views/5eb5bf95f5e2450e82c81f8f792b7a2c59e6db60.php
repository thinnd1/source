...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('/backend/css/custom-css/dropzone.css')); ?>">
    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">

    <script src="<?php echo e(asset('/backend/vendor/jquery/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(url('/backend/js/dropzone.js')); ?>"></script>
    <script src="<?php echo e(url('/backend/js/custom-js/dropzone-config.js')); ?>"></script>
...
<body id="page-top">
    ...
    <script>
        function goBack() {
            window.location.replace('<?php echo e(URL::to('/gallery')); ?>');
        }
    </script>
</body>

</html>
<?php /**PATH /home/iceiceice/Documents/SOURCE/resources/views/gallery/add_image.blade.php ENDPATH**/ ?>