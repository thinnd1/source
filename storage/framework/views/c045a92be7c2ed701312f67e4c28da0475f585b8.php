...
<body id="page-top">
    ...
    <div id="wrapper">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 mb-4 d-flex justify-content-center">
                                    ...
                                    <li class="list-group-item" style="width: 300px; height: 300px">
                                        ...
                                        <img class="img-thumbnail" style="width: 200px; height: 200px"
                                            src="/uploads/product/<?php echo e($photo->filename); ?>"
        ...
        <script src="<?php echo e(asset('/backend/js/custom-js/gallery.js')); ?>"></script>
</body>
<script>
...
<?php /**PATH /home/iceiceice/Documents/SOURCE/resources/views/gallery/all_image.blade.php ENDPATH**/ ?>