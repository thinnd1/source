<?php $__env->startSection('content_update_v2'); ?>
            ...
            <div>
                ...
                <div class="form-one" style="width:300px; margin: -10px 0 0 15px">
                    ...
                    <textarea name="shipping_email" style="margin: 0 0 5px 0" required="required" placeholder="Email*"
                        rows="1"><?php echo e($shipping_info->shipping_email); ?></textarea>
                    <textarea name="shipping_name" style="margin: 0 0 5px 0" required="required" placeholder="Tên*"
                        rows="1"><?php echo e($shipping_info->shipping_name); ?></textarea>
                    <textarea name="shipping_address" style="margin: 0 0 5px 0" required="required"
                        placeholder="Địa chỉ*" rows="1"><?php echo e($shipping_info->shipping_address); ?></textarea>
                    <textarea name="shipping_phone" style="margin: 0 0 5px 0" required="required"
                        placeholder="Số điện thoại*" rows="1"><?php echo e($shipping_info->shipping_phone); ?></textarea>
                ...
                <div style="margin: 300px 0 0 15px">
                    ...
                    ?>
                    <?php $__currentLoopData = $content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v_content1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <div>
                        ...
                        <button
                            style=" width: auto; height: 30px; font-size: 14px; margin: 20px 0 20px 20px; border: none; background-color: #FE980F"><a
                                style="color: white" href="<?php echo e(URL::to('/trang-chu')); ?>">Tiếp tục mua sắm</a></button>
                    </div>
                </div>
            </div>
                ...
                ?>
                    <table class="table table-condensed">
                        ...
                        <tbody style="text-align:center">
                            ...
                            <tr>
                                <td><img src="/uploads/product/<?php echo e($v_content->options->image); ?>" width="60"
                                        height="60"></td>
                                <td class="cart_description">
                                    <a href="<?php echo e(URL::to('/chi-tiet-san-pham/'.$v_content->id)); ?>">
                                        <p><?php echo e($v_content->name); ?></p>
                                    </a>
                                </td>
                                <td class="cart_price">
                                    <p><?php echo e(number_format($v_content->price, 0).' '.'VND'); ?></p>
                                </td>
                                <td class="cart_quantity">

                                    <p style="font-size:20px"><?php echo e($v_content->qty); ?></p>
                                </td>
                                <td class="cart_total">
                                ...
                                <div class="total_area" style="padding: 20px 25px 30px 0;margin-bottom: 20px">
                                    <ul>
                                        ...
                                        <li>Tổng Tiền Thanh Toán
                                            <span><?php echo e(number_format($total_order, 0).' '.'VND'); ?></span></li>
                                        <?php endif; ?>
                                    </ul>
                                </div>
                            </div>
...
<?php echo $__env->make('layout_update_v2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/iceiceice/Documents/SOURCE/resources/views/pages/checkout/payment.blade.php ENDPATH**/ ?>