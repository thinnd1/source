<?php $__env->startSection('content'); ?>
    ...
    <div class="features_items">
        ...
        <h2 class="title text-center" style="margin-top: 10px; color:red">Sản phẩm mới</h2>
                        ...
                        <a href="<?php echo e(URL::to('/chi-tiet-san-pham/'.$product->product_id)); ?>">
                            <div class="single-products">
                                <div class="productinfo text-center">
                                    <img style="height:250px" src="/uploads/product/<?php echo e($product->product_image); ?>"
                                         alt=""/>
                                    <h2 style="font-size:18px"><?php echo e(number_format($product->product_price).' '.'VND'); ?></h2>
                                    ...
                                    <button class="btn btn-default show-modal-product-detail" data-toggle="modal"
                                            data-target="#<?php echo e($product->product_id); ?>-modal" style="background-color:#f45555; color:white">
        ...
        <div class="col-sm-12 text-center"> <?php echo e($all_product->links()); ?></div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/iceiceice/Documents/SOURCE/resources/views/pages/home.blade.php ENDPATH**/ ?>