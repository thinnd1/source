                            ...
                            <tobdy>
                                <?php $__currentLoopData = $lich_su_nhan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($item->shipping_notes); ?></td>
                                        <td>
                                            ...
                                            <?php else: ?>
                                                ...
                                                <a href="<?php echo e(route('order_thanh_cong', ['id' => $item->order_id])); ?>" class="btn btn-warning">Thất Bại</a>
                                            <?php endif; ?>
...
<?php echo $__env->make('shippers.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/iceiceice/Documents/SOURCE/resources/views/shippers/lich_su_nhan_hang.blade.php ENDPATH**/ ?>