        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a class="btn btn-warning" href=""> Nhận giao </a>
                </div>
            </div>
...
<?php echo $__env->make('shippers.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\KHOA LUAN WEBSITE BAN HANG\KHOA LUAN WEBSITE BAN HANG\SOURCE\resources\views/shippers/chi_tiet.blade.php ENDPATH**/ ?>