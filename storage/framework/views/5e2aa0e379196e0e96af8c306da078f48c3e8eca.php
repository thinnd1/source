        ...
        <div class="col-lg-3 col-md-4">
            <div class="card m-1 border border-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="col-12">
                        <a href="<?php echo e(URL::to('/add-category-product')); ?>"><input type="button" class="btn btn-danger col-12 mt-2" value="Hủy"/></a>
                    </div>
                </div>
            </div>
        </div>
...
<script src="<?php echo e(asset('/backend/js/custom-js/category.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/iceiceice/Documents/SOURCE/resources/views/admin/add_category_product.blade.php ENDPATH**/ ?>