				...
				<div class="row" style="padding: 10px 0 0 0">
					<div class="">
						<div class="logo pull-left">
							<a href="<?php echo e(URL::to('/trang-chu')); ?>"><img style="width:50%; margin:-10px" src="<?php echo e(asset('/frontend/images/logo_sport1.png')); ?>"
									alt="" /></a>
						</div>
                    </div>
		...
		<div class="container">
			<div class="row">
										...
										<a href="<?php echo e(URL::to('/chi-tiet-san-pham/'.$sell->product_id)); ?>">
											<div class="single-products">
												<div class="productinfo text-center">
													<img style="height:220px;width:100%" src="/uploads/product/<?php echo e($sell->product_image); ?>" alt="" />
													<h2><?php echo e(number_format($sell->product_price).' '.'VND'); ?></h2>
													<p style="margin:-25px 0 0 0"><strong><?php echo e($sell->product_name); ?></strong></p>
												</div>
											</div>
										</a>
									</div>
				...
				<div class="col-sm-9 padding-right">
					...
					<?php echo $__env->yieldContent('content_update'); ?>
					...
					<div class="col-sm-2" style="padding: 0 0 0 50px">
						<div class="single-widget">
							...
							<ul class="nav nav-pills nav-stacked" style="padding: 0 0 0 15px">
								<li><a style=" font-size:16px" href="<?php echo e(URL::to('/trang-chu')); ?>">Trang chủ</a></li>
...
<?php /**PATH /home/iceiceice/Documents/SOURCE/resources/views/layout_update.blade.php ENDPATH**/ ?>